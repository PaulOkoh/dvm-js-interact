...
// const changeButtonColor = (sayHelloButton) =>
...
const myFunction = () => {
  axios.get("http://localhost:3000/query-test/?animal=cat").then((res) => {
    console.log(res.data);
  });
};
...
/*
    ...
    1: Send no queries on the URL -- what happened? 
    "You sent an empty query!" was logged on the console.
...
let addFoodBtn = document.querySelector("#add");
